...
%\oppnospace 70/30 gender split
 were asked to provide an antonym for each of 10 words; half of words were either abstract (adjectives) or concrete (nouns).  The Student’s t-test reveals that the count of antonyms for abstracts tend to be fewer than those for concretes.  Results concluded significance [$t(7.881)=3.55902, p < 0.00461577$].  
